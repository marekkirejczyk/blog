...
Author: Marek Kirejczyk (twitter: [@marekkirejczyk ](https://twitter.com/marekkirejczyk) )

*Originally published at * [*blog.daftcode.pl*](http://blog.daftcode.pl/pair-programming-demystified/) *.*