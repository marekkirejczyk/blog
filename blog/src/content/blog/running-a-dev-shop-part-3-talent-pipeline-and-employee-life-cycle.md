...
🥾 [Part 2: Bootstrapping and specialisation](/blog/running-a-dev-shop-part-2-bootstrapping-and-specialization)  
...
> _“On average, a Senior \[engineer\] from the market will achieve the same level of expertise in our company in two years as a freshly hired Junior in three years.”_
...
_The way is to attract young, highly talented people before or just after graduation, when they are about to enter the job market for the first time._
...
-   **Excitement about emerging technologies**. Young engineers are oftentimes attracted to new emerging technologies — it takes a small employer branding budget and a presence at local universities, to arouse their interest.   
    _The senior developer, on the other hand, needs to first resign from his current specialization to join the new one, which is often perceived as a risk with an unclear potential reward._
-   **Speed of learning.** Students and graduates are used to learning and getting into new stuff all the time, and so they are usually much more receptive to new technologies, as well as company methods and culture. _Unfortunately, more experienced developers are used to incremental learning and oftentimes accumulated bad habits_.
...
> _A great dev shop will be able to retain great talent for years and when an employee leaves, they should be able to find highly attractive positions as principal engineers, engineering managers, CTOs and founders._
...
![](https://cdn-images-1.medium.com/max/800/1*3DVHTrPManEiA6S213vJOQ.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*6Y109z0OdaCuLv8QwzQg0Q.jpeg)
...
_Most of the agencies and HR departments post on the same job portals, use similar search criteria \[on platforms like Linkedin\] and they all send similar boilerplate messages on a very highly competitive market. This approach typically leads to a limited success in attracting great talent_
...
![](https://cdn-images-1.medium.com/max/800/1*mvNymO38P86rs_ijrV7F1A.jpeg)
...
_We found out that throwing a simple technical question during the screening — an unusual practice — can reject around 50% of candidates at the screening stage, doing wonders to recruitment process efficiency. It saves many hours of technical interviews per hire._
...
![](https://cdn-images-1.medium.com/max/800/1*SEzGOOxO0hDe3H43kLCrSg.jpeg)
...
![](https://cdn-images-1.medium.com/max/800/1*pXas6ZSr7F3pLHir6sRhBA.jpeg)
...
It acts as a transparent system of promotions, which small companies often lack. And sends out a clear message to the employees and candidates: _learning is a big part of the job and you are going to be compensated for it_.
...
_One base requirement, however, for each promotion was to demonstrate ability to deliver working high-quality code_. Mentorship and leadership roles early on in the path would be an argument for fast-track, so as working on complex code.
...
![](https://cdn-images-1.medium.com/max/800/1*RKfLMeaxP_IYJubmPelIcQ.jpeg)
...
_Every end is a new beginning. Experienced person leaving is an opportunity for others to grow and fill the ranks._
...
![](https://cdn-images-1.medium.com/max/800/1*jHhzLToKPJSR42e8YcC9-g.jpeg)
...
With that part of the company explored, it is time to dive into the other side of the software house — attracting customers. Read the [next post in the series](/blog/running-a-dev-shop-part-4-attracting-customers).
