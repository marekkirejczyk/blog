...
![The Awesome Blockchain Project Funnel vs dapp](https://cdn-images-1.medium.com/max/800/1*18N1IL1rO1cvOMMujU7ytQ.png)
...
![Solving onboarding is confusing and feels bad sometimes, but it is a problem that we need to solve.](https://cdn-images-1.medium.com/max/800/1*ChQMODjiPIhkGyxZYECVrw.png)
...
![Solving onboarding forces you to go deeper again and again](https://cdn-images-1.medium.com/max/800/0*g7vIRdHsOJ5wLBPB.jpg)
...
-   The blockchain development model is surprisingly complicated in comparison to Web and Mobile development. And I am not even talking about security of smart-contracts or front-running. Rather about stuff like:  
    [👷](https://www.compart.com/en/unicode/U+1F477)Constructing an application state based on multiple sources: blockchain state, blockchain events, and database; reacting to state changes and edge-cases like network reorgs. As your application become successful it all becomes part of the game.  
    [👷](https://www.compart.com/en/unicode/U+1F477) Handling waiting for transactions, gas parameters, failed transactions.  
    [👷](https://www.compart.com/en/unicode/U+1F477) Occasionally looking at te mempool to give feedback on what is going on with their transaction.  
    [👷](https://www.compart.com/en/unicode/U+1F477)And there is only more stuff coming all the time with half a dozen of L2 solutions being around the corner
...
![What solving onboarding feels like](https://cdn-images-1.medium.com/max/800/1*3F_5wtzxzHrTS8rn-17_JA.gif)
