...
-   **MPC**  
    Along with ZKPs, another booming part of cryptography is _multi-party computation_ (MPC). They are used for setup ceremonies for ZKPs. And there is more than meets the eye. There is an ongoing effort to use MPC to take privacy further than ZKPs allow.
-   **New data structures**  
...
_The bottleneck in the development of modern cryptography is the lack of hands to work on sensitive cryptography-related code._ _This relates to both quality engineers writing code, as well as auditors._
...
I hope this will drive the diffusion of lesser known engineering practices. This will include [formal verification](https://en.wikipedia.org/wiki/Formal_verification) and [shift left security](https://www.crowdstrike.com/cybersecurity-101/shift-left-security/). We had the opportunity to introduce both of them in the smart contract team in my last job as CTO at Archblock and TrueFi. I have advocated for both ever since.
...
To learn them, I started a [hobby project](https://github.com/marekkirejczyk/zkmarek) I am working on in my free time. I am both implementing what I am learning, and working on animation in [Manim](https://www.manim.community/), which I will put on a newly created [youtube channel](https://www.youtube.com/@zkmarek). You can check them out using links below:
