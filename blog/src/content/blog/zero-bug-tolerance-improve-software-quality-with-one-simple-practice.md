...
It’s an easy Kanban practice we use at [EL Passion](http://elpassion.com/ "EL Passion"). Visualize your bugs on your Kanban board. Put them as a notes in different color (red or yellow to make them more visible). Always focus on fixing bugs before doing the tickets.

![zero bug tolerance](https://cdn-images-1.medium.com/max/800/0*sjOFHJc-XHQWcl6o.jpg)
...
-   **Don’t estimate the bugs**. Use [Planning Poker](http://blog.elpassion.com/planning-poker-estimation/) to estimate tickets, but not the bugs. Fixing bugs does not deliver value to the project. It is just fixing what the team did wrong in the past. Estimated bugs might disrupt your team velocity, creating an impression that team is delivering value.
